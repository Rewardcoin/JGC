...
static const int64_t COIN_YEAR_REWARD = 1 * CENT; // not used per year
static const int MODIFIER_INTERVAL_SWITCH = 216;

inline bool IsProtocolVCurrent(int nHeight) { return TestNet() || nHeight > 5000; }
