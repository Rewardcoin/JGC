...
#if defined(NDEBUG)
# error "JiaguCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "JiaguCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// JiaguCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("JiaguCoin-loadblk");
