...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("042f5acecb8079981bc2b5051bf0f8fd6455b261591be089c7ffc6476263dd94c8a73ead082e3369ed1d8405840fab135540e5aefc0e13efc3d50c76759ef39d9d");
        nDefaultPort = 16819;
        nRPCPort = 16818;
        ...
        const char* pszTimestamp = "JiaguCoin";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
		CTransaction txNew(1, 1456151369, vin, vout, 0);
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("04c34f0ec04b3178a2ac17bbce75d9fdd90620f6fd8353b9e303b030d2762b74aa6d551f79aeb3d46f3445969f150fab03df84cfdb2eabe822a6dfbc90ec3ceade");
        nDefaultPort = 26818;
        nRPCPort = 26819;
        strDataDir = "testnet";
...
public:
    CRegTestParams() {
        ...
        nDefaultPort = 18444;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x1dc03169e822b16e161d4b892327526afb139b033c90cf0e36a52720f6142b7d"));
